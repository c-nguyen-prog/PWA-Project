...
var LoginPage = /** @class */ (function () {
    function LoginPage(navCtrl, user, toastCtrl, translateService) {
        ...
        this.translateService.get('SERVER_ERROR').subscribe(function (value) {
            _this.serverErrorString = value;
        });
        this.translateService.get('ACCOUNT_ERROR').subscribe(function (value) {
            _this.accountErrorString = value;
        });
    }
    ...
    LoginPage.prototype.doLogin = function () {
        ...
        this.user.login(JSON.stringify(tempAccount)).subscribe(function (resp) {
            console.log(resp);
            if (resp.status === "success") {
                sessionStorage.setItem("username", _this.account.email);
                ...
                if (resp.reason === "no-match") {
                    ...
                    var toast = _this.toastCtrl.create({
                        message: _this.accountErrorString,
                        duration: 3000,
                        position: 'top'
                    });
                    toast.present();
