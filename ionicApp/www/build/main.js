...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__transfer_transferService__ = __webpack_require__(311);
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "d", function() { return __WEBPACK_IMPORTED_MODULE_4__transfer_transferService__["a"]; });
...
var map = {
	...
	"../pages/new-transaction/new-transaction.module": [
		339,
		10
	],
...
/* unused harmony export signup1 */
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "f", function() { return signup2; });
...
var Tab2Root = 'NewTransactionPage';
var Tab3Root = 'SettingsPage';
var signup1 = 'SignupPage';
var signup2 = 'SignupPage2';
//# sourceMappingURL=index.js.map
...
var TemplateService = /** @class */ (function () {
    function TemplateService(storage) {
        this.storage = storage;
        this.templates = [];
        this.loaded = false;
    }
    TemplateService.prototype.load = function () {
        var _this = this;
        //return promise so we know when operation is completed
        return new Promise(function (resolve) {
            //Get notes saved in storage
            _this.storage.get('templates').then(function (templates) {
    ...
    TemplateService.prototype.save = function () {
        //save current note array
        this.storage.set('templates', this.templates);
    };
    TemplateService.prototype.getTemplate = function (id) {
        //get specific note
        return this.templates.find(function (template) { return template.id === id; });
    };
    TemplateService.prototype.createTemplate = function (destination, recipient, amount, reference) {
        //create unique id that is one larger than current largest id
        var id = Math.max.apply(Math, this.templates.map(function (template) { return parseInt(template.id); }).concat([0])) + 1;
        this.templates.push({
            id: id.toString(),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__services_template_service__ = __webpack_require__(227);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["I" /* NgModule */])({
            ...
            providers: [
                ...
                __WEBPACK_IMPORTED_MODULE_11__providers__["d" /* TransferService */],
                __WEBPACK_IMPORTED_MODULE_13__services_template_service__["a" /* TemplateService */],
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_rxjs_add_operator_toPromise__ = __webpack_require__(185);
...
var User = /** @class */ (function () {
    ...
    User.prototype.contact = function (accountInfo) {
        var seq = this.api.post('contact', accountInfo).share();
        seq.subscribe(function (res) {
            // If the API returned a successful response, mark the user as logged in
        }, function (err) {
            console.error('ERROR', err);
...
var TransferService = /** @class */ (function () {
     ...
     * the user entered on the form.
     */
    TransferService.prototype.transfer = function (transferInfo) {
        var seq = this.api.post('transaction', transferInfo).share();
        seq.subscribe(function (res) {
            // If the API returned a successful response, mark the user as logged in
            if (res.status === "success") {
            }
...
var AppComponent = /** @class */ (function () {
    function AppComponent(translate, platform, settings, config, statusBar, splashScreen) {
        var _this = this;
        this.translate = translate;
        this.config = config;
        this.statusBar = statusBar;
        this.splashScreen = splashScreen;
        this.rootPage = this.showHomePage();
        this.pages = this.populateMenu();
    ...
    AppComponent.prototype.showHomePage = function () {
        if (sessionStorage.getItem("username")) {
            return __WEBPACK_IMPORTED_MODULE_5__pages__["c" /* Tab1Root */];
        }
        else {
            return __WEBPACK_IMPORTED_MODULE_5__pages__["a" /* FirstRunPage */];
        }
    };
    AppComponent.prototype.populateMenu = function () {
        var array = [
